...
/**
 * @params {Object} win ChromeWindow
 */
(function(win) {
  "use strict";
  ...
  TabSplit.view = {
    ...
    /**
     * @param {Object} params An object containing a `store`, `utils`, `gBrowser`, and `listener` property.
     * @param {Object} params.store TabSplit.store
     * @param {Object} params.utils TabSplit.utils
     * @param {XULElement} params.gBrowser <tabbrowser>
     * @param {Object} params.listener An object with event handling functions
     * @return {void}
     */
    init(params) {
    ...
    async update(newState, tabGroupsDiff) {
      ...
      try {
        ...
        let { added, removed } = tabGroupsDiff;
