...
(function(win) {
  ...
  // TODO: Maybe could remove this
    ...
    /**
     * @param {Object} params An object containing a `utils` property.
     ...
     *
     * @params {Object} actions state update actions. See Action below for details
     *
    ...
    /**
     * @param {Object} newTabGroup An object containing a `tabs`, `color`, and `layout` property.
     * @return {String} The new tabGroup id
     */
    ...
    /**
     * @param {Function} listener See `_listeners`
     * @return {void}
     */
    subscribe(listener) {
